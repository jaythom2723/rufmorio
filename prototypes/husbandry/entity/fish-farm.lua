ENTITY {
	...
	crafting_speed = 0.5,
	crafting_categories = {
		"rufmorio-fish-farming-category"
	},
	fixed_recipe = "rufmorio-raw-fish",
	max_health = 300,
	icon = "__base__/graphics/icons/assembling-machine-1.png",
	minable = {
		mining_time = 0.3,
		result = "rufmorio-fish-farm"
	},
	...
	allowed_module_categories = { "rufmorio-fish-egg-speed" },
	fluid_boxes =
    {
      {
